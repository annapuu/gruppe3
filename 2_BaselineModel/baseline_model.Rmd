...
validation_data <- data_sorted_filter %>% filter(Datum >= "2017-08-01")
...
The R-squared is smaller than before, so the model 7 with 7 bins might be the best option for now.
