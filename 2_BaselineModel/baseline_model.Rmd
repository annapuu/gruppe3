...
This model is again slightly better than model 7, so this one can be considered the best model for now.


Preparation for the next step of putting model 9 to use:
